	...
	<div class="container">
		<div class="row">
			<div class="col-lg-5">
				...
				&nbsp;<i class="fa fa-chevron-right"></i>&nbsp;
				<a href="/admin/category/update" class="admin-breadcrumbs">Edit category</a>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-4">
				<p class="admin-create-title">Editing category #<?=$category['id']?></p>
				<form action="" class="user_info" method="POST">
					<p>
						<label>Name:
							...
							?>
							<br>
							<input type="text" name="name" value="<?php if (isset($_POST['name'])) { echo htmlspecialchars($_POST['name']); } else { echo htmlspecialchars($category['name']); } ?>">
						</label>
					</p>
					<p>
						<label>Sort order:
							...
							?>
							<br>
							<input type="text" name="sort_order" value="<?php if (isset($_POST['sort_order'])) { echo htmlspecialchars($_POST['sort_order']); } else { echo htmlspecialchars($category['sort_order']); } ?>">
						</label>
					</p>
					<p>
						Status:<br>
