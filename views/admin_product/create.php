    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
                ...
                &nbsp;<i class="fa fa-chevron-right"></i>&nbsp;
                <a href="/admin/product/create" class="admin-breadcrumbs">Add new item</a>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-4">
                <p class="admin-create-title">Add new item</p>
                <form action="" class="user_info" method="POST" enctype="multipart/form-data">
                    ...
                    <p>
						<label>Code:
							...
							<br>
							<input type="text" name="code" value="<?php if (isset($_POST['code'])) echo htmlspecialchars($_POST['code']); ?>">
						</label>
					</p>
                    <p>
						<label>Price, &euro;:
                    ...
                    <p>
						<label>Brand:<br>
							<input type="text" name="brand" value="<?php if (isset($_POST['brand'])) echo htmlspecialchars($_POST['brand']); ?>">
						</label>
					</p>
                    <p>
						<label>Image:<br>
                    ...
                    <p>
						<label>Description:<br>
							<textarea name="description" rows="6"><?php if(isset($_POST['description'])) echo htmlspecialchars($_POST['description']); ?></textarea>
						</label>
					</p>
                    <p>Availability: <br>
